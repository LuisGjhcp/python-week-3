...
print(f"My name is {name}, im {age} and a good song is {song}. My favorite food is {food} and favorite number is {number}.")
...
# Print the data type of that variable.
decimal_num = 50.25
decimal_num = float(50.25)
print(type(decimal_num))
#python allows for implicit or explicit conversation
